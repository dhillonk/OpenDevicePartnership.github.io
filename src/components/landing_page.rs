...
pub fn LandingPage() -> impl IntoView {
    view! {
        ...
        >
            <div class="flex flex-col md:flex-row gap-[80px] items-start">
                {/* Left Column: h1 */}
                    ...
                    <span
                        class="h2_mobile md:h1 break-words w-full block text-left">
                ...
                <div class="flex flex-col items-start flex-shrink min-w-0 w-full md:w-[650px]">
                        <span
                            class="p2_mobile md:p1 break-words w-full block text-left">
        ...
        >
            <div>
                <h2
                    class="h2_mobile md:h2 text-left">
                    {"Value Proposition"}
                </h2>
                <div class="flex flex-col md:flex-row gap-[60px]">
                    ...
                    <div class="flex flex-col items-start w-full md:w-[400px]">
                        ...
                        <span
                            class="p2_mobile md:p2 break-words w-full block text-left">
        ...
        >
            <div class="flex flex-col md:flex-row gap-[60px]">
                ...
                <div class="flex flex-col items-start" style="flex: 1;">
                    <span
                        class="h3_mobile md:h3 block text-left">

    ...
    view! {
        <div class="background_primary px-2 md:px-[120px]" style="width: auto; height: auto;">
            <div class="flex flex-col md:flex-row gap-[80px] items-start">
                ...
                <div class="flex flex-col items-start flex-shrink min-w-0 w-full md:w-[650px]">
                    <span class="p2_mobile md:p1 break-words w-full block text-left">
            ...
            <div>
                ...
                <div class="flex flex-col md:flex-row gap-[60px]">
                    {} <div class="flex flex-col items-start w-full md:w-[400px]">
                        ...
                        <span class="p2_mobile md:p2 break-words w-full block text-left">
                    ...
                    </div> {} <div class="flex flex-col items-start w-full md:w-[400px]">
        ...
        >
            <div class="flex flex-col md:flex-row gap-[60px]">
                ...
                </div> {} <div class="flex flex-col items-start" style="flex: 1;">
                    <span class="h3_mobile md:h3 block text-left">{"Get Involved!"}</span>
                    <span class="p2_mobile md:p2 block text-left">
